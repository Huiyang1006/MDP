            ...
            if (line.length() ==0 || line.charAt(0) == '#') ;
                ...
                switch (seg[0]) {
                    case "size" -> {
                        ...
                        mdp3.row = seg[1].charAt(2) - 48;
                        mdp3.column = seg[1].charAt(0) - 48;
//                        System.out.println("Row: " + mdp.row + ", Column: " + mdp.column);
                    ...
                    case "walls" -> {
                        ...
                        mdp3.wall_row1 = seg[1].charAt(2) - 48 - 1;
                        mdp3.wall_row2 = seg[1].charAt(8) - 48 - 1;
                        mdp3.wall_column1 = seg[1].charAt(0) - 48 - 1;
                        mdp3.wall_column2 = seg[1].charAt(6) - 48 - 1;
...
//                        System.out.println("Wall_Row_2: " + mdp.wall_row2 + ", Wall_Column_2: " + mdp.wall_column2);
                    ...
                    case "terminal_states" -> {
                        ...
                        mdp3.terminal_row1 = seg2[0].charAt(2) - 48 - 1;
                        mdp3.terminal_row2 = seg2[1].charAt(2) - 48 - 1;
                        mdp3.terminal_row3 = seg2[2].charAt(2) - 48 - 1;
                        ...
                        mdp3.terminal_column1 = seg2[0].charAt(0) - 48 - 1;
                        mdp3.terminal_column2 = seg2[1].charAt(0) - 48 - 1;
                        mdp3.terminal_column3 = seg2[2].charAt(0) - 48 - 1;

                        mdp1.reward1 = seg2[0].charAt(5) - 48;
                        if (seg2[0].charAt(4) == '-') mdp1.reward1 = mdp1.reward1 * -1;
                        mdp3.reward1 = seg2[0].charAt(5) - 48;
                        if (seg2[0].charAt(4) == '-') mdp3.reward1 = mdp3.reward1 * -1;

                        mdp1.reward2 = seg2[1].charAt(5) - 48;
                        if (seg2[1].charAt(4) == '-') mdp1.reward2 = mdp1.reward2 * -1;
                        mdp3.reward2 = seg2[1].charAt(5) - 48;
                        if (seg2[1].charAt(4) == '-') mdp3.reward2 = mdp3.reward2 * -1;

                        mdp1.reward3 = seg2[2].charAt(5) - 48;
                        if (seg2[2].charAt(4) == '-') mdp1.reward3 = mdp1.reward3 * -1;
                        mdp3.reward3 = seg2[2].charAt(5) - 48;
                        if (seg2[2].charAt(4) == '-') mdp3.reward3 = mdp3.reward3 * -1;
...
//                        System.out.println("x: " + mdp.terminal_column3 + " y: " + mdp.terminal_row3 + " R: " + mdp.reward3);
                    ...
                    case "reward" -> {
                        ...
                        mdp3.transfer_reward = Double.parseDouble(seg[1].substring(1));
                        if (seg[1].charAt(0) == '-') mdp3.transfer_reward = mdp3.transfer_reward * -1;
//                        System.out.println("reward: " + mdp.transfer_reward);
                    ...
                    case "transition_probabilities" -> {
                        ...
                        mdp3.pRightExecution = Double.parseDouble(seg2[0]);
                        mdp3.pErrorExecution1 = Double.parseDouble(seg2[1]);
                        mdp3.pErrorExecution2 = Double.parseDouble(seg2[2]);
                        mdp3.pErrorExecution3 = Double.parseDouble(seg2[3]);
                    }

                    case "discount_rate" -> {
                        mdp1.discount_rate = Double.parseDouble(seg[1]);
                        mdp3.discount_rate = Double.parseDouble(seg[1]);
                    }

                    case "epsilon" -> {
                        mdp1.epsilon = Double.parseDouble(seg[1]);
                        mdp3.epsilon = Double.parseDouble(seg[1]);
                    }
                }
            }
        }
